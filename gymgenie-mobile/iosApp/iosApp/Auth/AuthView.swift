...
struct AuthView: View {
    ...
    var body: some View {
        mainLayout
            ...
            .onChange(of: nameField) { newValue in viewModel.onNameChanged(newValue) }
    ...
    private var socialSection: some View {
        VStack(spacing: 16) {
            ...
            HStack(spacing: 20) {
                SocialIconButton(imageName: "ic_google")
                SocialIconButton(imageName: "ic_apple")
                SocialIconButton(imageName: "ic_vk")
                SocialIconButton(imageName: "ic_telegram")
            }
        }
    }
