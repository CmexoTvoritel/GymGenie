...
struct WorkoutHistoryView: View {
    ...
    private var daySummary: some View {
        ...
        return HStack {
            Spacer()
            summaryColumn(emoji: "⏱", label: "Время", value: "\(totalMinutes) мин")
            Spacer()
            summaryColumn(emoji: "🔁", label: "Подходы", value: "\(totalSets)")
            Spacer()
            summaryColumn(emoji: "🔥", label: "ккал", value: "\(estimatedCalories)")
            Spacer()
        }
        .padding(.vertical, 16)
        .background(
    ...
    private func summaryColumn(emoji: String, label: String, value: String) -> some View {
        VStack(spacing: 4) {
            Text(emoji)
                .font(.system(size: 36))
            Text(value)
    ...
    private func historyCard(session: WorkoutSessionHistoryItem) -> some View {
        ...
        let muscleColors = Self.muscleGroupColors(session.primaryMuscleGroup)
        let muscleEmoji = Self.muscleGroupEmoji(session.primaryMuscleGroup)
    ...
    private struct MuscleGroupColor {
        let bg: Color
        let fg: Color
    }

    private static func muscleGroupColors(_ group: String?) -> MuscleGroupColor {
        switch group?.uppercased() {
        case "CHEST":
            return MuscleGroupColor(bg: Color(red: 1.0, green: 0.910, blue: 0.886), fg: Color(red: 0.914, green: 0.290, blue: 0.173))
        case "BACK":
            return MuscleGroupColor(bg: Color(red: 0.902, green: 0.933, blue: 1.0), fg: Color(red: 0.231, green: 0.357, blue: 0.859))
        case "QUADRICEPS", "HAMSTRINGS", "GLUTES", "CALVES", "LEGS":
            return MuscleGroupColor(bg: Color(red: 0.910, green: 0.969, blue: 0.910), fg: Color(red: 0.184, green: 0.620, blue: 0.267))
        case "BICEPS", "TRICEPS", "FOREARMS", "ARMS":
            return MuscleGroupColor(bg: Color(red: 1.0, green: 0.957, blue: 0.839), fg: Color(red: 0.722, green: 0.525, blue: 0.043))
        case "CARDIO":
            return MuscleGroupColor(bg: Color(red: 0.988, green: 0.910, blue: 0.949), fg: Color(red: 0.761, green: 0.149, blue: 0.361))
        case "ABS", "CORE":
            return MuscleGroupColor(bg: Color(red: 0.918, green: 0.902, blue: 1.0), fg: Color(red: 0.404, green: 0.255, blue: 0.851))
    ...
    private static func muscleGroupEmoji(_ group: String?) -> String {
        switch group?.uppercased() {
        case "CHEST": return "🫁"
        case "BACK": return "🦾"
        case "SHOULDERS", "SHOULDER": return "💪"
        case "BICEPS", "TRICEPS", "FOREARMS", "ARMS": return "💪"
        case "ABS", "CORE": return "🔥"
        case "QUADRICEPS", "HAMSTRINGS", "GLUTES", "CALVES", "LEGS": return "🦵"
